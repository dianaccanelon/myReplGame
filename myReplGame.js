...
console.log("\n\nIt's Friday night, Barbie & Ken are going on their 4th date <3\n");
...
console.log("Barbie: \"First things first what should I wear tonight? I have:\n a) A cute blue mini dress that compliments my eyes\n b) These leather leggings with a tanktop and a leather jacket\n c) A pair of jeans with a cute blazer.\"");

//QUESTION 1
let outfit = readlineSync.keyIn("\nWhat should barbie wear?\n",  {limit: 'abcABC'})

//QUESTION 1 - CONFIRMATION - ELSEIF


if(outfit == 'a' || outfit == 'A'){
    console.log(`Barbie: \"Ok! I will wear the cute blue mini! I'll go get dressed and finish getting ready. I have to hurry! Ken will be here any minute.\"`);
}else if (outfit == 'b' || outfit == 'B'){
    console.log(`Barbie: \"Ok! I will wear the leather leggings and jacket! I'll go get dressed and finish getting ready. I have to hurry! Ken will be here any minute.\"`);
}else if (outfit == 'c' || outfit == 'C'){
    console.log(`Barbie: \"Ok! I will wear the jeans and the blazer! I love this blazer. I'll go get dressed and finish getting ready. I have to hurry! Ken will be here any minute.\"`);
}
...
console.log("Barbie: \"He's here!\" Barbie opens the front door and greets Ken.");
console.log("Ken: \"Hi Barbie! Wow! You look amazing. Ready to go?\"\n");

console.log("KEN AND BARBIE HEAD OVER TO SOKAI, A JAPAENESE-PREUVIAN FUSION RESTAURANT. YUM!");
...
if(food == 'a' || food == 'A'){
    console.log("Ken: I am stuffed! Did you like your sushi pizza?\"");
}else if (food == 'b' || food == 'B'){
    console.log("Ken: I am stuffed! Did you like your beef tenderloin?\"");
}else if (food == 'c' || food == 'C'){
    console.log("Ken: I am stuffed! Did you like your salmon tacos?\"");
}




console.log("\nBarbie: \"It was absolutely delicious!\"\n");

console.log("Ken: \"Barbie, I have had a great time with you over these last few dates, I would really like to make you a part of my life. Will you be my girlfriend?\"");

//QUESTION 3

let gfAnswer = readlineSync.keyIn("What should Barbie say?\n a) YES!\n b) I think its too soon Ken, is it ok if we get to know each other more?\n c) No, I was really just looking to have fun.\n", {limit: 'abcABC'});

console.log("DINNER ENDS, KEN DRIVES BARBIE HOME AND WALKS HER TO HER DOOR")



if(gfAnswer == 'a' || gfAnswer == 'A'){
    console.log("Ken says \"Barbie, I had so much fun tonight. See you tomorrow, girlfriend.\" and leans in for a kiss.");
}else if (gfAnswer == 'b' || gfAnswer == 'B'){
    console.log("Ken says \"Barbie, I had so much fun tonight. I hope you did too. I'll call you tomorrow to setup another date?\"");
}else if (gfAnswer == 'c' || gfAnswer == 'C'){
    console.log("Ken says: \"I undestand you were only looking for fun Barbie, but I am looking for a relationship, it might be best for us to just be friends, I'll see you around.\"");
}




console.log("Barbie: \"Thanks for helping me tonight my friend!\"")
